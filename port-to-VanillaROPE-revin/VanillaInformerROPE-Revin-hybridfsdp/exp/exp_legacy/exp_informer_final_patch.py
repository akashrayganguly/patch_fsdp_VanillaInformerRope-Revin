...
FIXES FROM ORIGINAL:
1. GradScaler import updated for PyTorch 2.0+ compatibility
2. use_revin added to InformerStack extended param check
3. All other optimizations preserved (DataPrefetcher, no_sync, DeviceMesh, etc.)
...
class Exp_Informer(Exp_Basic):
    ...
    def train(self, setting):
        ...
        if self._should_print():
            ...
            print(f"  Data prefetcher: {self.use_prefetcher}")
            print(f"  AMP enabled: {use_amp} ({self.amp_config['name']})")
